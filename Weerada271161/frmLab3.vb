Public Class frmLab3
    ...
    Private Sub LalblFBlack_Click(sender As Object, e As EventArgs) Handles LalblFBlack.Click
        txtInput.ForeColor = Color.Black
    End Sub

    Private Sub lblFOrenge_Click(sender As Object, e As EventArgs) Handles lblFOrenge.Click
